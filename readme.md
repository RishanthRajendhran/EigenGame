...
<p>
    ...
    Longest Correct EigenVectors Streak, defined as the longest streak of consecutive eigenvectors with angular errors less than a specified angularThreshold (see arXiv:2010.00554 [cs.LG]), can be computed by using the "-computeLCES" flag. LCES is computed for the last played EigenGame and a plot of LCES vs time elapsed is saved in the "LCES" folder in the project directory. LCES at the last iteration is printed on the screen. <br/>
    ...
    To save the plots generated by the "-analyseResults" flag, use the "-savePlots" flagM<br/>
